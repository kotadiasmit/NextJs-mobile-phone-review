...
const Navbar = () => {
  ...
  return (
    <nav className="w-100 flex justify-between items-center bg-zinc-300 backdrop-blur-2xl dark:bg-zinc-800 border-b-2 border-gray-500  dark:border-gray-400 px-5 py-2">
